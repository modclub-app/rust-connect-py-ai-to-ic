...
//static STATE_ENCODED: &[u8] = include_bytes!("../../../python/onnx_model/gpt2_embedding.onnx");
static STATE_ENCODED_2: &[u8] = include_bytes!("../../../python/onnx_model/gpt2_embedding_mean_pool_two_layer.onnx");
...
fn sub_compute(input: NN_In_Out) -> NN_In_Out {
    let model_bytes_4 = bytes::Bytes::from_static(STATE_ENCODED_2);
